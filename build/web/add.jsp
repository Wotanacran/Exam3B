...
<html>
    ...
    <body>
        <div class="wrap"> <!--div to hold other divs-->
            ...
            <div class="main">
                <p>
                <form name ="addForm" action ="addCustomer" onsubmit="return validateForm()" method="get">
                    <fieldset>
                        <legend>Add A New Customer</legend>
                        <br>
                        <label class="field">First Name:</label>
                        <input type="text" name="fName" value="" pattern="[A-Z][A-Za-z]+" title="Only letters allowed.  Needs to be at least 2 letters long with the first letter capitalized"/>
                        <br><br>
                        <label class="field">Last Name:</label>
                        <input type="text" name="lName" value="" pattern="[A-Z][A-Za-z]+" title="Only letters allowed.  Needs to be at least 2 letters long with the first letter capitalized"/>
                        <br><br>
				...
				<option value="OK">Oklahoma</option>
        			...
        			<option value="WY">Wyoming</option>
                        ...
                        <input type="text" name="zip" value="" pattern="\d{5,5}" title="Zip codes are 5 nubmers long."/>
                        <br><br>
                        <label class="field">Email Address:</label>
                        <input type="email" name="email" value=""/>
                        <br><br>
                        <label class="field">Age:</label>
                        <input type="number" min="1" max="120" name="age" value="" />
                        <br>                      
                        <div class="center">
